...
function SitePageComponents() {
    ...
    return (
        <React.Fragment>
            <Helmet>
                <title>{`Components — ${localStorage.getItem("store-name")}`}</title>
            </Helmet>
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="alert alert-primary alert-lg mb-3 alert-dismissible fade show">
                                A simple large alert with <Link to="/">an example link</Link>. Give it a click if you
                                like.
                        ...
                        <div className="col-12 col-md-6">
                            <div className="alert alert-info mb-3">
                                A simple alert with <Link to="/">an example link</Link>. Give it a click if you like.
                            </div>
